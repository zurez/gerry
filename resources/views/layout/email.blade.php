...
<head>
    ...
    <title>{{$title or 'Cognitive Research '}}</title>
	...
	<div class="container">
		...
		<div class="row">
				...
				<tr>
					...
					$image_name=asset('assets/img/logo.png');?>

					<td style=""><a href="{{url('/')}}"><img src="{{$image_name}}" class="img" alt="CognitiveResearch" height="50px" width="180px"></a></td>
				</tr>
